...
# A python script that creates a CNN to classify fMRI images from the roi aal of the
#ABIDE dataset
...
if __name__ == '__main__':
    ...
    abide_aal = abide_aal = fetch_abide_pcp(derivatives = ['rois_aal'], pipeline = 'cpac', quality_checked = True, verbose = 0)
    ...
    #np.savetxt("./Connectivity_Data/corMatrix_aal.csv", corMatrix_aal, delimiter=",")
    tanMatrix_aal = tanMeasure.fit_transform(abide_aal.rois_aal)
    #np.savetxt("./Connectivity_Data/tanMatrix_aal.csv", tanMatrix_aal, delimiter=",")
    covMatrix_aal = covMeasure.fit_transform(abide_aal.rois_aal)
    #np.savetxt("./Connectivity_Data/covMatrix_aal.csv", covMatrix_aal, delimiter=",")
    partCorrMatrix_aal = partCorrMeasure.fit_transform(abide_aal.rois_aal)
    #np.savetxt("./Connectivity_Data/partCorrMatrix_aal.csv", partCorrMatrix_aal, delimiter=",")
    preMatrix_aal = preMeasure.fit_transform(abide_aal.rois_aal)
    #np.savetxt("./Connectivity_Data/preMatrix_aal.csv", preMatrix_aal, delimiter=",")
    
    #One hot encode output
    OneHot = OneHotEncoder()
    y_aal = y_aal.reshape((-1,1))
    OneHot.fit(y_aal)
    Y = OneHot.transform(y_aal).toarray()
    #Reshaping the connectivity matrices
    corMatrix_aal = corMatrix_aal.reshape(inputShape)
    tanMatrix_aal = tanMatrix_aal.reshape(inputShape)
    covMatrix_aal = covMatrix_aal.reshape(inputShape)
    partCorrMatrix_aal = partCorrMatrix_aal.reshape(inputShape)
    preMatrix_aal = preMatrix_aal.reshape(inputShape)
    
    print("Training models")
    
    print("Training Model with ReLU on Correlation")
    corRel = KFold_Validation_CNN(corMatrix_aal, Y, act_fun = 'relu',  out_fold = 10,ep = 75, b_size = 100, dropout = 0.2, learning_rate = 0.005)
    print(corRel)
    print("##################################################################################################################################")
    print("Training Model with Tanh on Correlation")
    corTan = KFold_Validation_CNN(corMatrix_aal, Y, act_fun = 'tanh',  out_fold = 10,ep = 75, b_size = 100, dropout = 0.2, learning_rate = 0.005)
    print(corTan)
    print("##################################################################################################################################")
    print("Training Model with Leaky Relu on Correlation")
    corLRel = KFold_Validation_CNN(corMatrix_aal, Y, act_fun = 'leaky_relu',  out_fold = 10,ep = 75, b_size = 100, dropout = 0.2, learning_rate = 0.005)
    print(corLRel)
    
    print("##################################################################################################################################")
    print("Training Model with ReLu on Tangent Matrix")
    tanRel = KFold_Validation_CNN(tanMatrix_aal, Y, act_fun = 'relu',  out_fold = 10,ep = 75, b_size = 100, dropout = 0.2, learning_rate = 0.005)
    print(tanRel)
    print("##################################################################################################################################")
    print("Training Model with Tanh on Tangent Matrix")
    tanTan = KFold_Validation_CNN(tanMatrix_aal, Y, act_fun = 'tanh',  out_fold = 10,ep = 75, b_size = 100, dropout = 0.2, learning_rate = 0.005)
    print(tanTan)
    print("##################################################################################################################################")
    print("Training Model with Leaky Relu on Tangent Matrix")
    tanLRel = KFold_Validation_CNN(tanMatrix_aal, Y, act_fun = 'leaky_relu',  out_fold = 10,ep = 75, b_size = 100, dropout = 0.2, learning_rate = 0.005)
    print(tanLRel)
    
    print("##################################################################################################################################")
    print("Training Model with ReLu on Covariance")
    covRel = KFold_Validation_CNN(covMatrix_aal, Y, act_fun = 'relu',  out_fold = 10,ep = 75, b_size = 100, dropout = 0.2, learning_rate = 0.005)
    print(covRel)
    print("##################################################################################################################################")
    print("Training Model with Tanh on Covariance")
    covTan = KFold_Validation_CNN(covMatrix_aal, Y, act_fun = 'tanh',  out_fold = 10,ep = 75, b_size = 100, dropout = 0.2, learning_rate = 0.005)
    print(covTan)
    print("##################################################################################################################################")
    print("Training Model with Leaky Relu on Covariance")
    covLRel = KFold_Validation_CNN(covMatrix_aal, Y, act_fun = 'leaky_relu',  out_fold = 10,ep = 75, b_size = 100, dropout = 0.2, learning_rate = 0.005)
    print(covLRel)
    
    print("##################################################################################################################################")
    print("Training Model with ReLu on Partial Correlation")
    pCorRel = KFold_Validation_CNN(partCorrMatrix_aal, Y, act_fun = 'relu',  out_fold = 10,ep = 75, b_size = 100, dropout = 0.2, learning_rate = 0.005)
    print(pCorRel)
    print("##################################################################################################################################")
    print("Training Model with Tanh on Partial Correlation")
    pCorTan = KFold_Validation_CNN(partCorrMatrix_aal, Y, act_fun = 'tanh',  out_fold = 10,ep = 75, b_size = 100, dropout = 0.2, learning_rate = 0.005)
    print(pCorTan)
    print("##################################################################################################################################")
    print("Training Model with Leaky Relu on Partial Correlation")
    pCorLRel = KFold_Validation_CNN(partCorrMatrix_aal, Y, act_fun = 'leaky_relu',  out_fold = 10,ep = 75, b_size = 100, dropout = 0.2, learning_rate = 0.005)
    print(pCorLRel)
    
    print("##################################################################################################################################")
    print("Training Model with ReLu on Precision")
    preRel = KFold_Validation_CNN(preMatrix_aal, Y, act_fun = 'relu',  out_fold = 10,ep = 75, b_size = 100, dropout = 0.2, learning_rate = 0.005)
    print(preRel)
    print("##################################################################################################################################")
    print("Training Model with Tanh on Precision")
    preTan = KFold_Validation_CNN(preMatrix_aal, Y, act_fun = 'tanh',  out_fold = 10,ep = 75, b_size = 100, dropout = 0.2, learning_rate = 0.005)
    print(preTan)
    print("##################################################################################################################################")
    print("Training Model with Leaky Relu on Precision")
    preLRel = KFold_Validation_CNN(preMatrix_aal, Y, act_fun = 'leaky_relu',  out_fold = 10,ep = 75, b_size = 100, dropout = 0.2, learning_rate = 0.005)
    print(preLRel)

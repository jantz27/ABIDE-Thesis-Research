...
# A python script that creates a CNN to classify fMRI images from the roi cc200 of the
#ABIDE dataset
...
if __name__ == '__main__':
    ...
    abide_cc200 = abide_cc200 = fetch_abide_pcp(derivatives = ['rois_cc200'], pipeline = 'cpac', quality_checked = True, verbose = 0)
    ...
    #np.savetxt("./Connectivity_Data/corMatrix_cc200.csv", corMatrix_cc200, delimiter=",")
    tanMatrix_cc200 = tanMeasure.fit_transform(abide_cc200.rois_cc200)
    #np.savetxt("./Connectivity_Data/tanMatrix_cc200.csv", tanMatrix_cc200, delimiter=",")
    covMatrix_cc200 = covMeasure.fit_transform(abide_cc200.rois_cc200)
    #np.savetxt("./Connectivity_Data/covMatrix_cc200.csv", covMatrix_cc200, delimiter=",")
    partCorrMatrix_cc200 = partCorrMeasure.fit_transform(abide_cc200.rois_cc200)
    #np.savetxt("./Connectivity_Data/partCorrMatrix_cc200.csv", partCorrMatrix_cc200, delimiter=",")
    preMatrix_cc200 = preMeasure.fit_transform(abide_cc200.rois_cc200)
    #np.savetxt("./Connectivity_Data/preMatrix_cc200.csv", preMatrix_cc200, delimiter=",")
    
    #One hot encode output
    OneHot = OneHotEncoder()
    y_cc200 = y_cc200.reshape((-1,1))
    OneHot.fit(y_cc200)
    Y = OneHot.transform(y_cc200).toarray()
    #Reshaping the connectivity matrices
    corMatrix_cc200 = corMatrix_cc200.reshape(inputShape)
    tanMatrix_cc200 = tanMatrix_cc200.reshape(inputShape)
    covMatrix_cc200 = covMatrix_cc200.reshape(inputShape)
    partCorrMatrix_cc200 = partCorrMatrix_cc200.reshape(inputShape)
    preMatrix_cc200 = preMatrix_cc200.reshape(inputShape)
    
    print("Training models")
    
    print("Training Model with ReLU on Correlation")
    corRel = KFold_Validation_CNN(corMatrix_cc200, Y, act_fun = 'relu',  out_fold = 10,ep = 75, b_size = 100, dropout = 0.2, learning_rate = 0.005)
    print(corRel)
    print("##################################################################################################################################")
    print("Training Model with Tanh on Correlation")
    corTan = KFold_Validation_CNN(corMatrix_cc200, Y, act_fun = 'tanh',  out_fold = 10,ep = 75, b_size = 100, dropout = 0.2, learning_rate = 0.005)
    print(corTan)
    print("##################################################################################################################################")
    print("Training Model with Leaky Relu on Correlation")
    corLRel = KFold_Validation_CNN(corMatrix_cc200, Y, act_fun = 'leaky_relu',  out_fold = 10,ep = 75, b_size = 100, dropout = 0.2, learning_rate = 0.005)
    print(corLRel)
    
    print("##################################################################################################################################")
    print("Training Model with ReLu on Tangent Matrix")
    tanRel = KFold_Validation_CNN(tanMatrix_cc200, Y, act_fun = 'relu',  out_fold = 10,ep = 75, b_size = 100, dropout = 0.2, learning_rate = 0.005)
    print(tanRel)
    print("##################################################################################################################################")
    print("Training Model with Tanh on Tangent Matrix")
    tanTan = KFold_Validation_CNN(tanMatrix_cc200, Y, act_fun = 'tanh',  out_fold = 10,ep = 75, b_size = 100, dropout = 0.2, learning_rate = 0.005)
    print(tanTan)
    print("##################################################################################################################################")
    print("Training Model with Leaky Relu on Tangent Matrix")
    tanLRel = KFold_Validation_CNN(tanMatrix_cc200, Y, act_fun = 'leaky_relu',  out_fold = 10,ep = 75, b_size = 100, dropout = 0.2, learning_rate = 0.005)
    print(tanLRel)
    
    print("##################################################################################################################################")
    print("Training Model with ReLu on Covariance")
    covRel = KFold_Validation_CNN(covMatrix_cc200, Y, act_fun = 'relu',  out_fold = 10,ep = 75, b_size = 100, dropout = 0.2, learning_rate = 0.005)
    print(covRel)
    print("##################################################################################################################################")
    print("Training Model with Tanh on Covariance")
    covTan = KFold_Validation_CNN(covMatrix_cc200, Y, act_fun = 'tanh',  out_fold = 10,ep = 75, b_size = 100, dropout = 0.2, learning_rate = 0.005)
    print(covTan)
    print("##################################################################################################################################")
    print("Training Model with Leaky Relu on Covariance")
    covLRel = KFold_Validation_CNN(covMatrix_cc200, Y, act_fun = 'leaky_relu',  out_fold = 10,ep = 75, b_size = 100, dropout = 0.2, learning_rate = 0.005)
    print(covLRel)
    
    print("##################################################################################################################################")
    print("Training Model with ReLu on Partial Correlation")
    pCorRel = KFold_Validation_CNN(partCorrMatrix_cc200, Y, act_fun = 'relu',  out_fold = 10,ep = 75, b_size = 100, dropout = 0.2, learning_rate = 0.005)
    print(pCorRel)
    print("##################################################################################################################################")
    print("Training Model with Tanh on Partial Correlation")
    pCorTan = KFold_Validation_CNN(partCorrMatrix_cc200, Y, act_fun = 'tanh',  out_fold = 10,ep = 75, b_size = 100, dropout = 0.2, learning_rate = 0.005)
    print(pCorTan)
    print("##################################################################################################################################")
    print("Training Model with Leaky Relu on Partial Correlation")
    pCorLRel = KFold_Validation_CNN(partCorrMatrix_cc200, Y, act_fun = 'leaky_relu',  out_fold = 10,ep = 75, b_size = 100, dropout = 0.2, learning_rate = 0.005)
    print(pCorLRel)
    
    print("##################################################################################################################################")
    print("Training Model with ReLu on Precision")
    preRel = KFold_Validation_CNN(preMatrix_cc200, Y, act_fun = 'relu',  out_fold = 10,ep = 75, b_size = 100, dropout = 0.2, learning_rate = 0.005)
    print(preRel)
    print("##################################################################################################################################")
    print("Training Model with Tanh on Precision")
    preTan = KFold_Validation_CNN(preMatrix_cc200, Y, act_fun = 'tanh',  out_fold = 10,ep = 75, b_size = 100, dropout = 0.2, learning_rate = 0.005)
    print(preTan)
    print("##################################################################################################################################")
    print("Training Model with Leaky Relu on Precision")
    preLRel = KFold_Validation_CNN(preMatrix_cc200, Y, act_fun = 'leaky_relu',  out_fold = 10,ep = 75, b_size = 100, dropout = 0.2, learning_rate = 0.005)
    print(preLRel)
